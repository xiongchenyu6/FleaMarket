...
alter table booking_model drop foreign key fk_booking_model_user_model_id;
drop index ix_booking_model_user_model_id on booking_model;

alter table booking_model drop foreign key fk_booking_model_outlet_model_id;
drop index ix_booking_model_outlet_model_id on booking_model;
